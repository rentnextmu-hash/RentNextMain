...
**Next up:** either continue the fast-track (the booking flow is the natural next piece, since it's the other half of the demo script) or return to the blueprint's own P-number order for full V1 completeness — ask before assuming which.
