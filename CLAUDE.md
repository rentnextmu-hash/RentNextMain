...
**Next up:** push 0010 live then deploy. Then P9.3: Supabase Storage + ImageUpload, the owner-only /admin/settings page (company + booking settings, category rates/content, add-ons), and the polish pass (loading/error/not-found everywhere, a11y, OG images).
