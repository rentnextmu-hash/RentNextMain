...
**Blocks B3/B4 — Public pages (P3.3, P3.4, P4.1): built and verified locally; migration 0009 NOT yet applied live — push it before deploying (the /locations page reads the new `location_fleet_counts` view).**
...
**Next up:** push 0009 live then deploy. Then B9: P9.1 locations admin (the place to edit the new drive times/FAQs/opening hours), P9.2 hotel partners, P9.3 storage/settings/polish. Navbar still links to /about and /contact, which don't exist.
