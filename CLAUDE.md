...
**Next up:** per the blueprint, B9 (P9.1 locations admin, P9.2 hotel partners, P9.3 storage/settings/polish), plus the still-missing public pages (P3.3 `/cars/[slug]` — the fleet carousel links to it — P3.4 search, P4.1 location pages).
